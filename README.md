...
"com.softwaremill.sttp.apispec" %% "openapi-model" % "0.4.0"
// circe encoders for the model classes
"com.softwaremill.sttp.apispec" %% "openapi-circe" % "0.4.0"
...
"com.softwaremill.sttp.apispec" %% "asyncapi-model" % "0.4.0"
// circe encoders for the model classes
"com.softwaremill.sttp.apispec" %% "asyncapi-circe" % "0.4.0"
// extension method for AsyncAPI to convert to yaml
"com.softwaremill.sttp.apispec" %% "asyncapi-circe-yaml" % "0.4.0"
```
