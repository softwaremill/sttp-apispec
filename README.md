...
"com.softwaremill.sttp.apispec" %% "asyncapi-model" % "0.3.1"
// circe encoders for the model classes
"com.softwaremill.sttp.apispec" %% "asyncapi-circe" % "0.3.1"
