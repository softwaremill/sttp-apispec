...
"com.softwaremill.sttp.apispec" %% "apispec-model" % "0.11.7"
...
"com.softwaremill.sttp.apispec" %% "asyncapi-model" % "0.11.7"
// circe encoders for the model classes
"com.softwaremill.sttp.apispec" %% "asyncapi-circe" % "0.11.7"
// extension method for AsyncAPI to convert to yaml
"com.softwaremill.sttp.apispec" %% "asyncapi-circe-yaml" % "0.11.7"
```
