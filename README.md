...
"com.softwaremill.sttp.apispec" %% "openapi-model" % "0.6.3"
// circe encoders for the model classes
"com.softwaremill.sttp.apispec" %% "openapi-circe" % "0.6.3"
...
"com.softwaremill.sttp.apispec" %% "asyncapi-model" % "0.6.3"
// circe encoders for the model classes
"com.softwaremill.sttp.apispec" %% "asyncapi-circe" % "0.6.3"
// extension method for AsyncAPI to convert to yaml
"com.softwaremill.sttp.apispec" %% "asyncapi-circe-yaml" % "0.6.3"
```
