...
class SchemaComparator(
  ...
  /** Returns a mapping from discriminator values to schemas associated with them. All the schemas in the result are
    * references (local or non-local).
    */
